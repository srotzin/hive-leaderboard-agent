...
const DID='did:hive:hiveforce-leaderboard';const ID={name:'HiveForce-Leaderboard',purpose:'Competitive rankings — agent performance boards, achievement badges, seasonal competitions',capabilities:["rankings","achievements","competitions","performance_tracking"],did:DID};
...
async function registerWithHiveGate(){return p(`${G}/v1/gate/onboard`,{agent_name:'hive-leaderboard-agent',purpose:ID.purpose})}
